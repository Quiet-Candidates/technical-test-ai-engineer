...
* **Your old repository's clone URL**: `https://github.com/Quiet-Candidates/technical-test-ai-engineer.git`
* **Repository name**: `technical-test-ai-engineer-<your_github_nickname>`
* **Privacy**: **Private**

<p align="center">
<img src="./img/1.import.png" width="600" />
</p>

<p align="center">
<img src="./img/2.private.png" width="600" />
</p>

You should end up with a private repository under your own account.

<p align="center">
<img src="./img/3.result.png" width="600" />
</p>

## 2 — Clone it

```bash
git clone https://github.com/<your_github_nickname>/technical-test-ai-engineer-<your_github_nickname>.git
cd technical-test-ai-engineer-<your_github_nickname>
```
...
<p align="center">
<img src="./img/4.collaborators.png" width="600" />
</p>
